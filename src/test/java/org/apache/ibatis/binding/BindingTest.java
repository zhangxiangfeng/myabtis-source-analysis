...
public class BindingTest {
    ...
    public static void setup() throws Exception {
        DataSource dataSource = BaseDataTest.createAccountDataSource();
//        BaseDataTest.runScript(dataSource, BaseDataTest.ACCOUNT_DDL);
//        BaseDataTest.runScript(dataSource, BaseDataTest.ACCOUNT_DATA);
